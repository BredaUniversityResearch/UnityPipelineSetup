...
def ConvertStringToBool(myString):
    if(myString == "false"):
        myString = bool(0)
    else:
        myString = bool(1)
...
win_build = ConvertStringToBool(win_build)

mac_build = sys.argv[4]
mac_build = ConvertStringToBool(mac_build)

android_build = sys.argv[5]
android_build = ConvertStringToBool(android_build)
